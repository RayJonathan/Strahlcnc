...
const Grid: React.FC = () => {
    const items: Item[] = [
        { id: 1, title: 'Contoh Design', image: '/partisi (1).png' },
        { id: 2, title: 'Contoh Design', image: '/partisi (2).png' },
        { id: 3, title: 'Contoh Design', image: '/partisi (3).png' },
        { id: 4, title: 'Contoh Design', image: '/partisi (4).png' },
        { id: 5, title: 'Contoh Design', image: '/partisi (5).png' },
        { id: 6, title: 'Contoh Design', image: '/partisi (6).png' },
        { id: 7, title: 'Contoh Design', image: '/partisi (7).png' },
        { id: 8, title: 'Contoh Design', image: '/partisi (8).png' },
        { id: 9, title: 'Contoh Design', image: '/partisi (9).png' },
        { id: 10, title: 'Contoh Design', image: '/partisi (10).png' },
    ];
