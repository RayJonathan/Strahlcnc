...
function ProductPage() {
    ...
    return (
        <>
            <div className="relative h-64 sm:h-80 md:h-96 lg:h-112 xl:h-128 bg-cover bg-center" style={{ backgroundImage: "url('/partisi.webp')" }}>
                <div className="absolute inset-0 bg-black opacity-40"></div>
                <div className="absolute inset-0 flex items-center justify-center text-center">
                    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white">Partisi</h1>
                </div>
            </div>
